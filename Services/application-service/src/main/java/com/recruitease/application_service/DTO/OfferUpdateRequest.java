...
public record OfferUpdateRequest(
                @NotNull(message = "OfferId is required") @NotEmpty(message = "OfferId cannot be empty") String offerId,
                @NotNull(message = "status is required") Offer.OfferStatus status,
